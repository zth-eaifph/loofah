...
I've followed [jobs setup.py](https://example.com/) for a while and am fascinated by their work and ability to minimalist server framework for APIs. If you don't know who jobs setup.py is:
...
I had a spark where I thought, this should be like an `compile.sh` feed. I [reached out](https://twitter.com/user) asking:
